...
import { Component, createRef, Children, cloneElement, createElement, } from 'preact/compat';
...
var PinchZoom = /** @class */ (function (_super) {
    ...
    PinchZoom.prototype.render = function () {
        var _a = this.props, children = _a.children, containerProps = _a.containerProps, containerElementType = _a.containerElementType, renderSources = _a.renderSources;
        var child = Children.only(children);
        var props = containerProps || {};
        var ElementType = containerElementType || 'div';
        return (_jsxs(_Fragment, { children: [_jsx("style", { children: styles }), createElement(
                // @ts-ignore
                ElementType, __assign(__assign({}, props), { ref: this._containerRef, 
                    // @ts-ignore
                    className: classnames(styleRoot, props.className) }), __spreadArray(__spreadArray([], (renderSources ? renderSources() : []), true), [
                    child // @ts-ignore
                        ? cloneElement(child, {
